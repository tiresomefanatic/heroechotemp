...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-YtloGEka.mjs';
import { u as useContentPreview } from './preview-BkP52PQp.mjs';
import { f as useState, e as useRuntimeConfig, a as __nuxt_component_0$1 } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
import 'node:path';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-viIvThbM.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-DcZPjdOR.mjs.map
