import { y as withLeadingSlash, t as joinURL, z as withoutTrailingSlash, R as withBase, B as hash } from '../nitro/nitro.mjs';
import { e as useRuntimeConfig, h as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-viIvThbM.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-YtloGEka.mjs.map
