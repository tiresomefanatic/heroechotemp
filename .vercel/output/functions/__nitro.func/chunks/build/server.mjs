import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, toRef, isRef, useSSRContext, defineComponent, h, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, unref, resolveComponent, mergeProps, withCtx, createTextVNode, createApp, effectScope, reactive, getCurrentScope, computed, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, D as baseURL, c as createError$1, l as defu, E as defuFn, F as klona, G as createDefu, H as parseQuery, I as getContext, J as createHooks, K as hasProtocol, t as joinURL, L as isScriptProtocol, M as withQuery, N as sanitizeStatusCode, O as withTrailingSlash, z as withoutTrailingSlash, P as toRouteMatcher, Q as createRouter$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "auth-callback",
    path: "/auth/callback",
    component: () => import('./callback-CuNoKVkt.mjs')
  },
  {
    name: "design-slug",
    path: "/design/:slug(.*)*",
    component: () => import('./_...slug_-CAlbKFcQ.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BhgqTCj7.mjs')
  },
  {
    name: "test",
    path: "/test",
    component: () => import('./test-Bp6FOv9m.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-CepMns6u.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-Dz-C3uHr.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-DcZPjdOR.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-Bam4FjGV.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-DTUOOogH.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-BKLUg2Wn.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-LBm4sO1I.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-Dmkf3HMj.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-D5tgRcS0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BWTCbiBA.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-Bdq0eMfl.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-D_HoEJuq.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-Ci9ETcC_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-He0fQm8i.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-zxwxKFp7.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-AzIPFbgO.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-SmorFTXP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-DxApif-J.mjs').then((r) => r["default"] || r.default || r));
...
const LazyIcon = defineAsyncComponent(() => import('./index-PNT267WD.mjs').then((r) => r["default"] || r.default || r));
...
const useGithubAuth = () => {
  ...
  const initiateLogin = () => {
    const clientId = (/* @__PURE__ */ useRuntimeConfig()).public.githubClientId;
    if (!clientId) {
      error.value = "GitHub client ID is not configured";
      return;
    }
    const redirectUri = (void 0).location.origin;
    const scope = "read:user user:email";
    const state = Math.random().toString(36).substring(7);
    localStorage.setItem("github_oauth_state", state);
    const authUrl = `https://github.com/login/oauth/authorize?client_id=${clientId}&redirect_uri=${redirectUri}&scope=${scope}&state=${state}`;
    (void 0).location.href = authUrl;
  };
  const handleCallback = async (code, state) => {
    ...
    try {
      const config2 = /* @__PURE__ */ useRuntimeConfig();
      const response = await $fetch(`${config2.public.siteUrl}/api/auth/token`, {
        method: "POST",
        body: { code }
      });
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-ff7bc91d><div class="header-content" data-v-ff7bc91d><div class="logo" data-v-ff7bc91d>`);
      ...
      _push(`<span class="logo-dot" data-v-ff7bc91d></span></div><nav class="nav" data-v-ff7bc91d>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/design/foundation/introduction",
        class: ["nav-link", { active: _ctx.$route.path.startsWith("/design") }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Design`);
      ...
      _push(`</nav><div class="header-right" data-v-ff7bc91d><div class="search" data-v-ff7bc91d><input type="text" placeholder="Search" class="search-input" data-v-ff7bc91d></div>`);
      if (loading.value) {
        _push(`<div class="loading-indicator" data-v-ff7bc91d> Loading... </div>`);
      } else if (unref(isAuthenticated) && user.value) {
        _push(`<div class="user-profile" data-v-ff7bc91d><div class="user-info" data-v-ff7bc91d><img${ssrRenderAttr("src", user.value.avatar_url)}${ssrRenderAttr("alt", user.value.login)} class="user-avatar" data-v-ff7bc91d><span class="user-name" data-v-ff7bc91d>${ssrInterpolate(user.value.login)}</span></div><button class="logout-button" data-v-ff7bc91d><span data-v-ff7bc91d>Logout</span></button></div>`);
      } else {
        _push(`<button class="login-button" data-v-ff7bc91d><svg class="github-icon" viewBox="0 0 24 24" width="16" height="16" data-v-ff7bc91d><path fill="currentColor" d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z" data-v-ff7bc91d></path></svg> Sign in with GitHub </button>`);
      }
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ff7bc91d"]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BootCVEA.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BboG4OAM.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useAppConfig as b, appConfig as c, useRoute as d, entry$1 as default, useRuntimeConfig as e, useState as f, get as g, useRequestEvent as h, useNuxtApp as i, asyncDataDefaults as j, createError as k, mergeConfig as m, omit as o, useHead as u };
