...
import { u as useRequestEvent, a as useContentPreview } from './preview-B1t3pASZ.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-YLtsr4t8.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CR2iDEUU.mjs.map
