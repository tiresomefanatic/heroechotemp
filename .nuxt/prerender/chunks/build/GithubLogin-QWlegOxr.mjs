import { m as mergeConfig, c as appConfig, t as twMerge, _ as _export_sfc, d as useRoute, l as useRouter, a as __nuxt_component_0$2 } from './server.mjs';
import { isEqual, diff } from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/ohash/dist/index.mjs';
import { defineComponent, useSSRContext, toRef, computed, getCurrentInstance, provide, inject, watch, mergeProps, unref, withCtx, createVNode, toDisplayString, createTextVNode, resolveDynamicComponent, renderSlot, openBlock, createBlock, createCommentVNode } from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass } from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/vue/server-renderer/index.mjs';
import __nuxt_component_0$3 from './index-D9w7d__H.mjs';
import { twJoin } from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
import { u as useUI } from './selectMenu-BKD1EU_L.mjs';
...
import 'file:///Users/suprateek/Desktop/hero-echo/node_modules/@iconify/utils/lib/css/icon.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UIcon = __nuxt_component_1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "auth-container" }, _attrs))} data-v-6efab08a>`);
      if (unref(error)) {
        _push(`<div class="error-message" role="alert" aria-live="polite" data-v-6efab08a>${ssrInterpolate(unref(error))}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(isAuthenticated)) {
        ...
        _push(ssrRenderComponent(_component_UButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="button-text" data-v-6efab08a${_scopeId}>${ssrInterpolate(unref(loading) ? "Signing in..." : "Sign in with GitHub")}</span>`);
            } else {
              return [
                createVNode("span", { class: "button-text" }, toDisplayString(unref(loading) ? "Signing in..." : "Sign in with GitHub"), 1)
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`<p class="auth-help" data-v-6efab08a> Sign in to edit and contribute to the documentation </p><!--]-->`);
      } else {
        _push(`<!--[--><div class="auth-success" data-v-6efab08a>`);
        _push(ssrRenderComponent(_component_UIcon, {
          name: "i-heroicons-check-circle",
          class: "success-icon",
          "aria-hidden": "true"
        }, null, _parent));
        _push(`<span data-v-6efab08a>Successfully authenticated with GitHub</span></div>`);
        _push(ssrRenderComponent(_component_UButton, {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/GithubLogin.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined;
};
const GithubLogin = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6efab08a"]]);

export { GithubLogin as default };
//# sourceMappingURL=GithubLogin-QWlegOxr.mjs.map
