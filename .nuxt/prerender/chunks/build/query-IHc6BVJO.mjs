...
import { f as useRuntimeConfig, g as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BBSxiBV-.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-IHc6BVJO.mjs.map
