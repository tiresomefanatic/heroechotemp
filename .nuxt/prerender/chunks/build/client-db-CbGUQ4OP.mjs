import memoryDriver from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/unstorage/drivers/memory.mjs';
import { prefixStorage, createStorage } from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/unstorage/dist/index.mjs';
import { withBase, joinURL } from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/ufo/dist/index.mjs';
import { c as createQuery, o as omit, g as get, b as assertArray, d as ensureArray, f as sortList, h as apply, i as withoutKeys, k as withKeys } from './query-j5O-Njgv.mjs';
import { pascalCase } from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/scule/dist/index.mjs';
import { b as useNuxtApp, h as useRuntimeConfig } from './server.mjs';
import { u as useContentPreview } from './preview-CKhac6nT.mjs';
import 'file:///Users/suprateek/Desktop/hero-echo/node_modules/ohash/dist/index.mjs';
import 'file:///Users/suprateek/Desktop/hero-echo/node_modules/vue/index.mjs';
  ...
  return {
    ...
    $regex: (item, condition) => {
      if (!(condition instanceof RegExp)) {
        ...
        condition = (matched == null ? undefined : matched[1]) ? new RegExp(matched[1], matched[2] || "") : new RegExp(condition);
      }
...
function createPipelineFetcher(getContentsList) {
  ...
  const matchingPipelines = [
    ...
    function fetchSurround(state, params, db) {
      var _a;
      if (params.surround) {
        let _surround = surround(((_a = state.result) == null ? undefined : _a.length) === 1 ? db : state.result, params.surround);
  ...
  const transformingPiples = [
    ...
    function fetchDirConfig(state, params, db) {
      var _a, _b, _c;
      if (params.dirConfig) {
        const path = ((_a = state.result[0]) == null ? undefined : _a._path) || ((_c = (_b = params.where) == null ? undefined : _b.find((w) => w._path)) == null ? undefined : _c._path);
...
function createPipelineFetcherLegacy(getContentsList) {
  ...
  return async (query) => {
    ...
    if (params.surround) {
      return result == null ? undefined : result.surround;
    }
    if (result == null ? undefined : result.dirConfig) {
      result.result = {
        _path: (_a = result.dirConfig) == null ? undefined : _a._path,
        ...result.result,
        _dir: result.dirConfig
      };
    }
    return result == null ? undefined : result.result;
  };
}
...
function createNav(contents, configs) {
  ...
  const pickNavigationFields = (content) => ({
    ...
    ...isObject(content == null ? undefined : content.navigation) ? content.navigation : {}
  });
  const nav = contents.sort((a, b) => a._path.localeCompare(b._path)).reduce((nav2, content) => {
    var _a;
    const parts = content._path.substring(1).split("/");
    const idParts = content._id.split(":").slice(1);
    const isIndex = !!((_a = idParts[idParts.length - 1]) == null ? undefined : _a.match(/([1-9][0-9]*\.)?index.md/g));
    ...
    if (isIndex) {
      ...
      if (typeof (dirConfig == null ? undefined : dirConfig.navigation) !== "undefined" && !(dirConfig == null ? undefined : dirConfig.navigation)) {
        return nav2;
      }
      if (content._path !== "/") {
    ...
    const siblings = parts.slice(0, -1).reduce((nodes, part, i) => {
      ...
      if (typeof (conf == null ? undefined : conf.navigation) !== "undefined" && !conf.navigation) {
        return [];
      }
...
function sortAndClear(nav) {
  ...
  for (const item of sorted) {
    if ((_a = item.children) == null ? undefined : _a.length) {
...
async function generateNavigation(query) {
  ...
  const configs = dirConfigs.reduce((configs2, conf) => {
    var _a;
    if (((_a = conf.title) == null ? undefined : _a.toLowerCase()) === "dir") {
...
//# sourceMappingURL=client-db-CbGUQ4OP.mjs.map
