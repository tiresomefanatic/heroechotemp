import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Users/suprateek/Desktop/hero-echo/node_modules/ohash/dist/index.mjs';
import { h as useRuntimeConfig, i as useRequestEvent } from './server.mjs';
...
function createQuery(fetcher, opts = {}) {
  ...
  const resolveResult = (result) => {
    ...
    if (opts.legacy) {
      ...
      return (result == null ? undefined : result._path) || Array.isArray(result) || !Object.prototype.hasOwnProperty.call(result, "result") ? result : result == null ? undefined : result.result;
    }
    return result;
  };
  const query = {
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CbGUQ4OP.mjs').then((m) => m.useContentDatabase());
...
function queryContent(query, ...pathParts) {
  ...
  queryBuilder.params = () => {
    ...
    if (!((_a = params.sort) == null ? undefined : _a.length)) {
      params.sort = [{ _stem: 1, $numeric: true }];
    }
    if (content.locales.length) {
      const queryLocale = (_c = (_b = params.where) == null ? undefined : _b.find((w) => w._locale)) == null ? undefined : _c._locale;
      if (!queryLocale) {
        params.where = params.where || [];
...
//# sourceMappingURL=query-j5O-Njgv.mjs.map
