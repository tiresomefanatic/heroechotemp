...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-IHc6BVJO.mjs';
import { u as useContentPreview } from './preview-Jbyp4472.mjs';
import { b as useState, f as useRuntimeConfig, j as __nuxt_component_0 } from './server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BBSxiBV-.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-DrXEqagn.mjs.map
