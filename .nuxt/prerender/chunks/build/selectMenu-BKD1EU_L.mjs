...
import { j as useAppConfig, m as mergeConfig, k as get, o as omit } from './server.mjs';
...
const useUI = (key, $ui, $config, $wrapperClass, withAppConfig = false) => {
  ...
  const ui = computed(() => {
    ...
    return mergeConfig(
      (_ui == null ? undefined : _ui.strategy) || ((_a = appConfig.ui) == null ? undefined : _a.strategy),
...
export { useUI as u };
//# sourceMappingURL=selectMenu-BKD1EU_L.mjs.map
