...
import CreatePullRequest from "./CreatePullRequest-Df8cfafm.js";
      ...
      if (activeTab.value === "history") {
        ...
        if (loading.value) {
          ...
          ssrRenderList(commits.value, (commit) => {
            ...
            if ((_a = commit.author) == null ? void 0 : _a.avatar_url) {
...
export {
  CollaborationSidebar as default
};
//# sourceMappingURL=CollaborationSidebar-DFU81baI.js.map
