...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isOpen.value) {
        _push(`<div class="dialog" data-v-b53b07ac><div class="dialog-header" data-v-b53b07ac><h2 class="dialog-title" data-v-b53b07ac>Add Content</h2><button class="close-button" data-v-b53b07ac>×</button></div><div class="tabs" data-v-b53b07ac><div class="tab-list" data-v-b53b07ac><button class="${ssrRenderClass([{ active: activeTab.value === "components" }, "tab-button"])}" data-v-b53b07ac> Components </button><button class="${ssrRenderClass([{ active: activeTab.value === "sections" }, "tab-button"])}" data-v-b53b07ac> Sections </button></div><div style="${ssrRenderStyle(activeTab.value === "components" ? null : { display: "none" })}" class="tab-content" data-v-b53b07ac><div class="content-grid" data-v-b53b07ac><!--[-->`);
...
export {
  AddContentDialog as default
};
//# sourceMappingURL=AddContentDialog-CEHj1nx2.js.map
