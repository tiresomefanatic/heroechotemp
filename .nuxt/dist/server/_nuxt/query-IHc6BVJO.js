...
import "destr";
import "klona";
import { g as useRuntimeConfig, h as useRequestEvent } from "../server.mjs";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-BBSxiBV-.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-IHc6BVJO.js.map
