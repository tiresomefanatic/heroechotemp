...
declare module '@nuxt/schema' {
  interface NuxtOptions {
    ...
    /**
     * Configuration for `nuxt-monaco-editor`
     */
    ["monacoEditor"]: typeof import("nuxt-monaco-editor").default extends NuxtModule<infer O> ? O : Record<string, any>
    /**
  ...
  interface NuxtConfig {
    ...
    modules?: (undefined | null | false | NuxtModule<any> | string | [NuxtModule | string, Record<string, any>] | ["@nuxtjs/mdc", Exclude<NuxtConfig["mdc"], boolean>] | ["@nuxt/content", Exclude<NuxtConfig["content"], boolean>] | ["@nuxt/icon", Exclude<NuxtConfig["icon"], boolean>] | ["@nuxtjs/color-mode", Exclude<NuxtConfig["colorMode"], boolean>] | ["@nuxtjs/tailwindcss", Exclude<NuxtConfig["tailwindcss"], boolean>] | ["@nuxt/ui", Exclude<NuxtConfig["ui"], boolean>] | ["nuxt-monaco-editor", Exclude<NuxtConfig["monacoEditor"], boolean>] | ["@nuxt/devtools", Exclude<NuxtConfig["devtools"], boolean>] | ["@nuxt/telemetry", Exclude<NuxtConfig["telemetry"], boolean>])[],
  }
}
declare module 'nuxt/schema' {
  interface NuxtOptions {
    ...
    /**
     * Configuration for `nuxt-monaco-editor`
     * @see https://www.npmjs.com/package/nuxt-monaco-editor
     */
    ["monacoEditor"]: typeof import("nuxt-monaco-editor").default extends NuxtModule<infer O> ? O : Record<string, any>
    /**
     * Configuration for `@nuxt/devtools`
